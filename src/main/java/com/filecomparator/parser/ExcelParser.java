...
public class ExcelParser implements FileParser {
    ...
    private static final int MAX_BYTE_ARRAY_OVERRIDE = 200_000_000;
        ...
        try (FileInputStream fis = new FileInputStream(new File(input));
            ...
            for (int i = 0; i < workbook.getNumberOfSheets(); i++) {
                ...
                for (Row row : sheet) {
                    ...
                    for (Cell cell : row) {
                        tableRow.add(getCellValueAsString(cell));
                    }
                    table.add(tableRow);
                }
    ...
    private String getCellValueAsString(Cell cell) {
        ...
        switch (cell.getCellType()) {
            ...
            case NUMERIC:
                ...
                else return Double.toString(cell.getNumericCellValue());
